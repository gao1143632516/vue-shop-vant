!function(U) {
    (function(e) {
        ...
        t = function() {
            ...
            ) : l ? ((p = new MessageChannel).port1.onmessage = h,
            b = function() {
                return p.port2.postMessage(0)
            }
            ) : b = void 0 === e && "function" == typeof require ? function() {
                try {
                    var e = require("vertx");
            ...
            function T(e, t, n) {
                var o, r, a, i;
                t.constructor === e.constructor && n === y && t.constructor.resolve === _ ? (a = e,
                (i = t)._state === A ? I(a, i._result) : i._state === C ? x(a, i._result) : M(i, void 0, function(e) {
                    return E(a, e)
                }, function(e) {
                    return x(a, e)
                })) : n === S ? (x(e, S.error),
                S.error = null) : void 0 === n ? I(e, t) : s(n) ? (o = t,
                r = n,
                u(function(t) {
                    var n = !1
                      , e = function(e, t, n, o) {
            ...
            function I(e, t) {
                e._state === B && (e._result = t,
                e._state = A,
                0 !== e._subscribers.length && u(L, e))
            }
            function x(e, t) {
                e._state === B && (e._state = C,
                e._result = t,
                u(D, e))
            }
            function M(e, t, n, o) {
            ...
            function L(e) {
                var t = e._subscribers
                  , n = e._state;
                if (0 !== t.length) {
                    for (var o = void 0, r = void 0, a = e._result, i = 0; i < t.length; i += 3)
                        o = t[i],
                        r = t[i + n],
                        o ? O(n, o, r, a) : r(a);
            ...
            function O(e, t, n, o) {
                ...
                if (r) {
                    ...
                    a.error = null) : u = !0,
                    t === a)
                        return void x(t, new TypeError("A promises callback cannot return that same promise."))
                } else
                    a = o,
                    u = !0;
            ...
            function j(e, t) {
                ...
                this._enumerate(),
                0 === this._remaining && I(this.promise, this._result))) : x(this.promise, new Error("Array Methods must be provided an Array"))
            }
            function z(e) {
                this[w] = F++,
                this._result = this._state = void 0,
                this._subscribers = [],
                P !== e && ("function" != typeof e && function() {
            ...
            return j.prototype._enumerate = function() {
                for (var e = this.length, t = this._input, n = 0; this._state === B && n < e; n++)
            ...
            j.prototype._settledAt = function(e, t, n) {
                var o = this.promise;
                o._state === B && (this._remaining--,
                e === C ? x(o, n) : this._result[t] = n),
...
function(r) {
    "use strict";
    var a, e, o = "AlipayJSBridge", v = r[o], t = navigator.userAgent || navigator.swuserAgent, n = "apm-h5", i = r.window, u = r.document, g = r.console, c = r.parseInt, s = [], l = {
        getBAPSI: {
            isListening: !1,
            lastState: 2,
            on: function() {
                l.getBAPSI.isListening || (v.call("startMonitorBackgroundAudio"),
            ...
            listener: function(e) {
                ...
                n && t !== l.getBAPSI.lastState && (y.trigger(n),
                l.getBAPSI.lastState = t)
            }
        }
    }, b = {
        ...
        getBluetoothDevices: {
            ...
            a: function(e) {
                return q(e.devices) && L(e.devices, function(e, t) {
                    S(t, {
        ...
        setNavigationBar: {
            ...
            d: function(e, t) {
                ...
                W(e[n]) || v.call(n, e[n]),
                W(e[r]) || (v.call(r, e[r]),
                V(e[r].color) && (a.error = 2,
                a.errorMessage = "颜色值不合法")),
                W(e[o]) ? d(t, a) : v.call(o, e[o], function(e) {
                    a = Q(e, a),
                    t(a)
                })
            }
        ...
        showActionSheet: {
            ...
            b: function(t) {
                ...
                return F(t.cancelBtn) && (t.cancelBtn = "取消"),
                t
            },
            a: function(e, t) {
        ...
        share: {
            ...
            d: function(e, n) {
                ...
                v.call("startShare", l.share.startShare, function(e) {
        ...
        getLocation: {
            b: function(e) {
                ...
                N() && (F(e.isHighAccuracy) && (e.isHighAccuracy = !0),
                F(e.isNeedSpeed) && (e.isNeedSpeed = !0)),
                e
            },
            a: function(e) {
                return S(e, {
        ...
        showPopMenu: {
            ...
            d: function(e, n) {
                var t = "showPopMenu";
                !0 !== l.showPopMenu.onEvent && (l.showPopMenu.onEvent = !0,
        ...
        setOptionButton: {
            ...
            b: function(n) {
                ...
                F(n.icon) || (n.icon = C("%b", n.icon)),
                U(l.setOptionButton) ? l.setOptionButton.menus = [] : l.setOptionButton = {
                    menus: []
                },
                q(n.menus)) {
                    var o = n.menus;
                ...
                if (j(l.setOptionButton.onEvent) && y.off("optionMenu", l.setOptionButton.onEvent),
                j(n.onClick)) {
                    var r = n.onClick
                      , e = function(e) {
                        var t = 0
        ...
        alipayVersion: (e = t.match(/AlipayClient[a-zA-Z]*\/(\d+(?:\.\d+)+)/),
        e && e.length ? e[1] : ""),
        ...
        parseQueryString: function(e) {
            var t, n = {}, o = e || i.location.search, r = {
                true: !0,
                false: !1
            };
            o = (o = 0 === o.indexOf("?") ? o.substr(1) : o) ? o.split("&") : "";
            for (var a = 0; a < o.length; a++)
                (t = o[a].split("="))[1] = decodeURIComponent(t[1]),
        ...
        call: function() {
            ...
            function e(n, o) {
                ...
                c = function(e, t) {
                    var n = {};
                    j((t = t || {}).success) && (n.success = t.success,
                    delete t.success);
                    j(t.fail) && (n.fail = t.fail,
                    delete t.fail);
                    j(t.complete) && (n.complete = t.complete,
                    delete t.complete);
                    return n
                }(0, u),
                ...
                e = function(e) {
                    ...
                    F(t = function(e, t, n, o, r) {
                        var a = b[e]
                          , i = a && a.a ? a.a((c = t,
                        "[object Event]" === J(c) ? t : Q({}, t)), n, o, r) : Q({}, t)
                    ...
                    t = A(r, t),
                    T(r, f, u, e, t),
                    M(t, "error") || M(t, "errorMessage") ? (j(o) && o(t),
                    j(c.fail) && c.fail(t)) : (j(n) && n(t),
                    j(c.success) && c.success(t)),
                    j(c.complete) && c.complete(t),
                    j(i) && i(t)
                }
                ,
                j(l) ? l(u, e, a, i) : s ? (_(s, i, e, c),
                y.on(s, e)) : t ? w(t, i) : v.call((p = b[h = r]) && p.m ? p.m : h, u, e),
                k(r)
            }
            f() ? e() : s.push(m)
        },
    ...
    function p(e, n, t) {
        var o, r = !1;
        return F(e) || (l.EVENTS || (l.EVENTS = {}),
        l.EVENTS[e] || (l.EVENTS[e] = {
            callbacks: []
        }),
    ...
    function P(e, t) {
        ...
        return n && r.test(t) && (t = t.match(r),
        !(o = n.m) && t[1] && t[2] && (o = function(e) {
            z(e) && (e = e.toLowerCase());
            return e
        }(t[1]) + t[2])),
        o
    ...
    function S(a, i, u) {
        ...
        L(i, function(e, t) {
            ...
            o && (r.k = o[1],
            r.t = o[2]),
            !F(t = (c = r).k) && (M(a, e) || M(u, e)) && F(a[t]) && (a[t] = C(c.t, F(u[e]) ? a[e] : u[e]),
            t !== e && delete a[e])
        }),
        a
    }
    ...
    function T() {
        ...
        o = i[3],
        r = i[4],
        a = [3 < i.length ? "RETURN>" : "INVOKE>", e, M(t, "_") ? t._ : t, n],
        3 < i.length && a.push(o),
        4 < i.length && a.push(r),
        g.info(a))
    }
    ...
    var D = i.requestAnimationFrame || i.webkitRequestAnimationFrame || i.mozRequestAnimationFrame || i.msRequestAnimationFrame || function(e, t) {
